        ...
        <div className="footer">
            <div className="container">
                <div className="row footer-menu">
                    <div className="col-6 col-sm-3 col-lg-3">Temas para ver
                        <ul>
                            <li>Coronavirus</li> 
                    ...
                    <div className="col-6 col-sm-3 col-lg-3">Secciones
                        <ul>
                            <li>Política</li>
                            <li>Policiales</li> 
                            <li>Sociedad</li>                             
                    ...
                    <div className="col-6 col-sm-3 col-lg-3">Entretenimientos
                        <ul>
                            <li>Espectáculos</li>
                            <li>Televisión</li>
                        </ul>
                    </div>
                    <div className="col-6 col-sm-3 col-lg-3">Redes Sociales

                    </div>
                </div>
                <div className="row footer-base">
                    <div className="col-3 text-center footer-logo">
                        {props.name}
                    </div>                    
                    <div className="col-9">
